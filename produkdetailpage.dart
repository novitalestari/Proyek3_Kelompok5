...
// import 'package:spicyfoods/constans.dart';
// import 'package:spicyfoods/helpers/dbhelper.dart';

// import 'dart:async';
// import 'dart:convert';

// import 'package:spicyfoods/models/cabang.dart';
...
//   Future fetchCabang() async {
//     List<Cabang> usersList;
//     var params = "/cabang";
//     try {
//       // var url = Uri.https(Palette.sUrl, params, {'q': '{http}'});
//       var url = Uri.parse(Palette.sUrl + params);
...
//         List<Cabang> usersList = jsonItems.map<Cabang>((json) { return Cabang.fromJson(json);
//         }).toList();
//         setState(() {
